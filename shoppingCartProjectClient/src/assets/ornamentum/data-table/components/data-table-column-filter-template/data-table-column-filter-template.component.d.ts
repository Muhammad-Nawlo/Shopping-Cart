...
export declare class DataTableColumnFilterTemplateComponent implements OnInit, OnDestroy {
     ...
     */
    clearFilter(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DataTableColumnFilterTemplateComponent, never>;
    static ɵcmp: ɵngcc0.ɵɵComponentDeclaration<DataTableColumnFilterTemplateComponent, "ng-data-table-column-filter-template", never, { "column": "column"; "customFilterStream": "customFilterStream"; "index": "index"; }, { "filter": "filter"; }, never, never>;
}

//# sourceMappingURL=data-table-column-filter-template.component.d.ts.map