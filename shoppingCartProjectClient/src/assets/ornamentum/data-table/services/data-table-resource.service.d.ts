...
export declare class DataTableResourceService<T> {
     ...
     */
    dispose(): void;
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<DataTableResourceService<any>, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<DataTableResourceService<any>>;
}

//# sourceMappingURL=data-table-resource.service.d.ts.map