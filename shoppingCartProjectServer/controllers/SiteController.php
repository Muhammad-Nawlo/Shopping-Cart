...
class SiteController extends Controller
{
    ...
    public function actionLogin()
    {
        ...
        if ($user) {
            ...
            $accessToken = Yii::$app->jwt->getBuilder()
                ...
                ->withClaim('user', ['name' => $user->username, 'isAdmin' => $user->isAdmin, 'id' => $user->id])// Configures a new claim, called "uid"
    ...
    public function actionSignup()
    {
        ...
        $user->phone = isset($data['phone']) && $data['phone'] != '' ? trim($data['phone']) : '';
